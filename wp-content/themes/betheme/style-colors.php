...
@media only screen and ( max-width: 767px ){
	...
	#Action_bar .social li a,
	#Action_bar .social-menu a{
		color: <?php echo esc_attr(mfn_opts_get('mobile-color-action-bar-social', '#bbbbbb')) ?>
	}

	#Action_bar .social li a:hover,
	#Action_bar .social-menu a:hover{
		color: <?php echo esc_attr(mfn_opts_get('mobile-color-action-bar-social-hover', '#777777')) ?>
	}
}
