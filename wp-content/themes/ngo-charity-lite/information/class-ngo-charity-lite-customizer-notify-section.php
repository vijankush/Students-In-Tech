<?php
/**
 * Ngo Charity Lite Lite Customizer Notification Section Class.
 *
 * @package Ngo Charity Lite Lite
 */


/**
 * Ngo_Charity_Lite_Customizer_Notify_Section class
 */
class Ngo_Charity_Lite_Customizer_Notify_Section extends WP_Customize_Section {
	/**
	...
	public function json() {
		...
		foreach ( $ti_customizer_notify_recommended_actions as $key => $ti_customizer_notify_recommended_action ) {
			...
			if ( isset( $ti_customizer_notify_recommended_action['plugin_slug'] ) ) {
				...
				$ti_customizer_notify_recommended_action['url'] = ngo_charity_lite_create_action_link( $active['needs'], $ti_customizer_notify_recommended_action['plugin_slug'] );
		...
		foreach ( $ti_customizer_notify_recommended_plugins as $slug => $plugin_opt ) {
			...
			$ti_customizer_notify_recommended_plugin['url'] = ngo_charity_lite_create_action_link( $active['needs'], $slug );
			if ( $active['needs'] !== 'install' && $active['status'] ) {
